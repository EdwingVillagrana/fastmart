 ...
 * @author Kevin Rios
 */
public class DlgVentasDetalles extends javax.swing.JDialog {
     ...
     */
    public DlgVentasDetalles(java.awt.Frame parent, boolean modal, Venta venta) {
        super(parent, modal);
        initComponents();
        this.venta = venta;
...
//            java.util.logging.Logger.getLogger(DlgVentasDetalles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                DlgVentasDetalles dialog = new DlgVentasDetalles(new javax.swing.JFrame(), true);
